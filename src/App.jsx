...
const STRINGS = {
  en: {
    ...
    resultsFootnote: "Estimates from posted PDFs · verify with Transportation Office",
    ...
    routesFootnote: "Times from posted PDFs where available; others estimated. Verify with the Transportation Office.",
    backToRoutes: "← Routes",
    trial: "Trial",
    stopsHeader: "Stops",
    ...
    disclaimer: "Community-built shuttle planner. Not affiliated with, endorsed by, or operated by USAG Humphreys, the U.S. Army, or the Department of Defense. Route schedules transcribed from publicly posted USAG Humphreys PDFs; verify with the Transportation Office before relying on it.",
  ...
  ko: {
    ...
    resultsFootnote: "공개 PDF 기반 추정 · 교통과에 확인하세요",
    ...
    routesFootnote: "공개 PDF가 있는 노선은 실제 시간, 나머지는 추정입니다. 교통과에 확인하세요.",
    backToRoutes: "← 노선",
    trial: "시범",
    stopsHeader: "정류장",
    ...
    pickupLabel: "탑승 지점:",
    schedulesLabel: "시간표:",
    disclaimer: "사용자 제작 셔틀 플래너입니다. USAG 험프리스, 미 육군 또는 미 국방부와 제휴되어 있거나 승인된 것이 아닙니다. 노선 시간표는 공개된 USAG 험프리스 PDF에서 옮긴 것입니다. 운행 전 교통과에 확인하세요.",

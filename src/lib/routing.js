...
export const STOP_ALIASES = {
  ...
  "Family Housing Towers (Tropic Lightning Ave)": ["Tropic Lightning Towers", "Tropic Lightning", "Family Housing Twr 1", "FH Twr 1"],
  "Family Housing Towers (Taro Ave)": ["Taro Towers", "Taro Ave", "Family Housing Twr 2", "FH Twr 2", "5070s Block"],
  "Family Housing Towers (5050s Block)": ["FH Twr 1 return", "5050s Block"],
  "Family Housing Towers (5100s Block)": ["Family Housing Twr 3", "FH Twr 3", "5100s Block"],
  "Family Housing Towers (15th Street)": ["15th Street Towers", "15th Street"],
  "USO Sentry Village":                ["USO"],
  "USO Sentry Village (Opposite)":     ["Opposite USO"],
  "Officer Housing":                   ["O-6 Housing"],

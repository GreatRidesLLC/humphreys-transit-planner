...
// Precomputed Mapbox walking pairs — { stops: {src: {dst: {seconds, meters}}}, bldgs: {bldg: {stop: ...}} }.
// Regenerated by scripts/gen_walk_matrix.py when stop_coords / buildings_osm change.
export const WALK_MATRIX = WALK_MATRIX_JSON || { stops: {}, bldgs: {} };
